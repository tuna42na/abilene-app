...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/g3tgoniMKF)
...
```sh
npx nx serve abilene-mobile
```

To create a production bundle:

```sh
npx nx build abilene-mobile
```

To see all available targets to run for a project, run:

```sh
npx nx show project abilene-mobile
```
