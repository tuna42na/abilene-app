          ...
          <View style={styles.section}>
            <View style={styles.shadowBox}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  Linking.openURL('https://cloud.nx.app/connect/aAOpKRuqXA');
                }}
              >
                <Text
                  style={[
          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                >
                  nx test AbileneMobile
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Lint
                </Text>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx lint AbileneMobile
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Run them together!
                </Text>
                ...
                >
                  nx run-many -p AbileneMobile -t build test lint
                </Text>
              </View>
